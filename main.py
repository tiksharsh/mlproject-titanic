...
def submission(clf, X):
    ...
    sub.to_csv("/Users/Wolverine/Desktop/Machine_Learning/DAGsHub/DagsHub-TitanicDataSet/Submission/submission.csv", index=False)
...
def train():
    ...
    with dagshub.dagshub_logger() as logger:
        ...
        joblib.dump(model, "/Users/Wolverine/Desktop/Machine_Learning/DAGsHub/DagsHub-TitanicDataSet/Model/model.joblib")
